...
### Local preview
1. Copy your `images/` folder from the old repo into this folder.
...
1. Delete all old files in your repo (`index.html`, `styles.css`, `script.js`).
2. Upload the new `index.html`, `styles.css`, `script.js`.
3. Keep your `images/` folder as-is.
4. Push to `main` branch.
5. GitHub Pages auto-deploys — live in ~60 seconds at:
   `https://biyyapu5e5.github.io/vaishnavi-portfolio/`
